    ...
    <div class="col-10 stretch-card">
      <div class="card">
       ...
       <!--    <p class="card-description">
          ...
          <?php echo form_open('job/save_company',array()) ?>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input type="date" name="founded_on" class="form-control" id="exampleInputEmail2" placeholder="Enter Address">
            </div>
          </div> 
           ...
           <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input type="text" name="total_employee" class="form-control" id="exampleInputEmail2" placeholder="Total Employee">
            </div>
          </div> 
