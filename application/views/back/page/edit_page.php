    ...
    <div class="col-10 stretch-card">
      <div class="card">
       ...
       <!--    <p class="card-description">
          ...
          <?php echo form_open_multipart('page/update_page/'.$page[0]->id,array()) ?>
          <div class="form-group row">
            <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Title</label>
            <div class="col-sm-9">
              <input type="text" name="title" value="<?php echo $page[0]->title; ?>" class="form-control" id="exampleInputEmail2" placeholder="Enter page title">
            </div>
          </div> 
