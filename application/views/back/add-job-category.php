    ...
    <div class="col-10 stretch-card">
      <div class="card">
       ...
       <!--    <p class="card-description">
          ...
          <?php echo form_open_multipart('job/save_job_category',array()) ?>
          <div class="form-group row">
            <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Job Title</label>
            <div class="col-sm-9">
              <input type="text" name="jobcat_name" class="form-control" id="exampleInputEmail2" placeholder="Enter job title">
            </div>
          </div> 
