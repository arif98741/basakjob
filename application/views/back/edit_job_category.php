...
<div class="main-panel">
  <div class="content-wrapper">
    ...
    <div class="col-10 stretch-card">
      <div class="card">
        <div class="card-body">
          <h4 class="card-title">Update Job Category</h4>
       <!--    <p class="card-description">
          ...
          <?php echo form_open_multipart('job/update_job_category/'.$jobcat[0]->jobcat_id,array()) ?>
          <div class="form-group row">
            <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Job Title</label>
            <div class="col-sm-9">
              <input type="text" name="jobcat_name" value="<?php echo $jobcat[0]->jobcat_name ?>" class="form-control" id="exampleInputEmail2" placeholder="Enter job title">
            </div>
          </div> 
