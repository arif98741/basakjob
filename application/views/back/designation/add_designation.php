<div class="main-panel">
  <div class="content-wrapper">
    ...
    <div class="col-10 stretch-card">
      <div class="card">
        <div class="card-body">
          <h4 class="card-title">Desingnation</h4>
       <!--    <p class="card-description">
          ...
          <?php echo form_open('job/save_designation',array()) ?>
          <div class="form-group row">
            <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Desingnation Name</label>
            <div class="col-sm-9">
              <input type="text" name="designation_name" class="form-control" id="exampleInputEmail2" placeholder="Enter designation name">
            </div>
          </div> 
