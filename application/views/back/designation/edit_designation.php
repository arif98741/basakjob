    ...
    <div class="col-10 stretch-card">
      <div class="card">
       ...
       <!--    <p class="card-description">
          ...
          <?php echo form_open_multipart('job/update_designation/'.$designation[0]->designation_id,array()) ?>
          <div class="form-group row">
            <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Designation Name</label>
            <div class="col-sm-9">
              <input type="text" name="designation_name" value="<?php echo $designation [0]->designation_name ?>" class="form-control" id="exampleInputEmail2" placeholder="Enter designation name">
            </div>
          </div> 
