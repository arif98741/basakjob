    ...
    <div class="col-10 stretch-card">
      <div class="card">
       ...
       <!--    <p class="card-description">
          ...
          <?php echo form_open('job/update_industry/'.$industry[0]->industry_id,array()) ?>
          <div class="form-group row">
            <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Edit Industry</label>
            <div class="col-sm-9">
              <input type="text" name="industry_name" value="<?php echo $industry[0]->industry_name ?>" class="form-control" id="exampleInputEmail2" placeholder="Enter industry name">
            </div>
          </div> 
