 ...
 <div id="content">
   <div class="container">
    ...
    <div class="row">
      <div class="col-sm-9 ma25" >
       ...
       <div class="col-sm-12"> 
         <div class="click-here">
           Recruiter? <span class="click-here"><a  href="http://198.38.86.159/~onlineexamboard/demo/advanced-job-portal/employer-login.html">Click here</a></span>
         </div>
       </div>
       <div class="eform">
        <div class="row">
          ...
          <div class="col-sm-9 m10"> 
            <span id="id1"></span></div>
              ...
              <?php echo form_open_multipart('employee/login_action',array('class'=>'form-horizontal')) ?>
            <div class="form-group">
              <label  class="col-sm-3   control-label efs"><span class="red-star">*</span> User name/Email</label>
              <div class="col-sm-9">
                <input type="text" class="form-control" name="username" id="username"  placeholder="User name / Email">
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <div class="col-sm-offset-3 col-sm-9  click-here">
                ...
                <span class="pull-left" style="font-size:14px;">Not a member as yet? <a  href="<?php echo base_url(); ?>employee/registration">Register Now</a></span>
                <span class="pull-right" style="font-size:14px;"><a href="#">Forgot Password?</a></span>
      ...
      <a href="http://198.38.86.159/~onlineexamboard/demo/advanced-job-portal/forgot-password.html">Forgot Password?</a>-->
