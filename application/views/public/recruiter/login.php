        ...
        <div class="row">
          ...
          <div class="col-sm-9 m10"> 
            <span id="id1"></span></div>
              ...
              <?php echo form_open('recruiter/login_action',array('class'=>'form-horizontal')) ?>
            ...
            <div class="form-group">
              <div class="col-sm-offset-3 col-sm-9  click-here">
                ...
                <span class="pull-left" style="font-size:14px;">Not a member as yet? <a  href="<?php echo base_url(); ?>recruiter/registration">Register Now</a></span>
