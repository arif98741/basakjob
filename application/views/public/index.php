     ...
     <!-- Mirrored from 198.38.86.159/~onlineexamboard/demo/advanced-job-portal/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 May 2019 20:26:25 GMT -->
     </html>
				...
				<div class="container">
					...
					<div class="col-sm-3 right_box">
						<div class="col-sm-12 base_box top_skill_box">
							<h4 class="head">Top Category</h4>
							<ul class="top_skill">
								<?php 
								foreach ($categories as $category) { ?>
									<li><a href='<?php  echo $category->jobcat_id?>' style="word-wrap: break-word;"><?php  echo $category->jobcat_name?></a></li>
								<?php }
								?>
			...
			<div class="container">
				<div class="row">
					...
					<div class="item wow fadeInUpBig animated animated col-sm-3 stat" >
						...
						<p class="number"><?php echo $totaljob; ?></p>
						<p>Jobs Posted</p>
					</div>
					
					<div class="item wow fadeInUpBig animated animated col-sm-3 stat" >
						<i class="fa fa-building-o"></i>
						<p class="number"><?php echo $totalcompany; ?></p>
						<p>Companies</p>
					</div>
					
					<div class="item wow fadeInUpBig animated animated col-sm-3 stat" >
						<i class="fa fa-list-ul"></i>
						<p class="number"><?php echo $totalcategory; ?></p>
						<p>Job Category</p>
					</div>
				</div>
			</div>
						...
						<div class="col-sm-12">
							<?php foreach($jobs as $job) { ?>
								...
								<div class="col-sm-12 recent_job_box">
									...
									<h4 class="compant_title"><?php  echo $job->jobcat_name;?></h4> 
									<ul class="job_dtl">
										<li class="loc"> <?php  echo $job->location;?></li>
										<li class="exp"><?php  echo $job->experience;?></li>

										<li class="sal"><?php  echo $job->salary_starting;?> to <?php  echo $job->salary_ending;?> to </li>
									</ul>
									<div class="clearfix"></div>
						...
						<div class="col-sm-12 base_box top_skill_box">
							...
							<ul class="top_skill">
								<?php foreach($designations  as $designation){ ?>
									...
									<li><a href="job-detail-pagedf91.html?jid=31491543252"><?php echo $designation->designation_name; ?></a></li>
								<?php } ?>
