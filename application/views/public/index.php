...
<!-- Mirrored from 198.38.86.159/~onlineexamboard/demo/advanced-job-portal/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 14 Apr 2019 20:16:35 GMT -->
		...
		<div class="row">
			<div class="col-sm-12">
				...
				<div class="row text-center">
					<div class="col-sm-4">
						<img src="<?php echo base_url(); ?>asset/public/assets1/img/how-it-work1.png" class="img-responsive">
						<h4>Post Resume</h4>
						<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes.</p>
					</div>
					<div class="col-sm-4">
						<img src="<?php echo base_url(); ?>asset/public/assets1/img/how-it-work2.png" class="img-responsive">
						<h4>Search Job</h4>
						<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes.</p>
					</div>
					<div class="col-sm-4">
						<img src="<?php echo base_url(); ?>asset/public/assets1/img/how-it-work3.png" class="img-responsive">
						<h4>Get Selected</h4>
						<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes.</p>
					</div>
				</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-2">
				...
				<div class="row">
					<div class="main-heading">
						<h2 class="font24i" style="line-height: inherit;">Top <span>Employers</span></h2>
					</div>
				</div>
				<div class="clearfix"></div>
	<!--<ul >
		<li><a href="#"><img src="<?php echo base_url(); ?>asset/public/assets1/img/c1.jpg" class="img-responsive"></a></li>
		<li><a href="#"><img src="<?php echo base_url(); ?>asset/public/assets1/img/c2.jpg" class="img-responsive"></a></li>
		<li><a href="#"><img src="<?php echo base_url(); ?>asset/public/assets1/img/c3.jpg" class="img-responsive"></a></li>
		<li><a href="#"><img src="<?php echo base_url(); ?>asset/public/assets1/img/c4.jpg" class="img-responsive"></a></li>
		<li><a href="#"><img src="<?php echo base_url(); ?>asset/public/assets1/img/c5.jpg" class="img-responsive"></a></li>
		<li><a href="#"><img src="<?php echo base_url(); ?>asset/public/assets1/img/c6.jpg" class="img-responsive"></a></li>
		<li><a href="#"><img src="<?php echo base_url(); ?>asset/public/assets1/img/c7.jpg" class="img-responsive"></a></li>
		<li><a href="#"><img src="<?php echo base_url(); ?>asset/public/assets1/img/c8.jpg" class="img-responsive"></a></li>
		<li><a href="#"><img src="<?php echo base_url(); ?>asset/public/assets1/img/c9.jpg" class="img-responsive"></a></li>
		<li><a href="#"><img src="<?php echo base_url(); ?>asset/public/assets1/img/c10.jpg" class="img-responsive"></a></li>
	</ul>-->
	<ul class="top_employers" style="padding:0px; margin-top:0px; ">
		<li>
			<a href="http://www.capgemini.com/" target="_blank">
		...
		<li>
			<a href="https://www2.deloitte.com/in/en.html" target="_blank">
...
<div class="col-sm-7">
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="home_page_job_tab">
									<!-- Nav tabs -->
									<ul class="nav nav-tabs" role="tablist">
										<li role="presentation" class="active"><a href="#tab-1-1" aria-controls="tab-1-1" role="tab" data-toggle="tab" aria-expanded="true">All Sectors </a></li>
										<li role="presentation" class=""><a href="#tab-1-2" aria-controls="tab-1-2" role="tab" data-toggle="tab" aria-expanded="false">Information Technology</a></li>
										<li role="presentation" class=""><a href="#tab-1-3" aria-controls="tab-1-3" role="tab" data-toggle="tab" aria-expanded="false">Manufacturing</a></li>
										<li role="presentation" class=""><a href="#tab-1-4" aria-controls="tab-1-4" role="tab" data-toggle="tab" aria-expanded="false">Services</a></li>
									</ul>
									...
									<div class="tab-content">
										<div role="tabpanel" class="tab-pane active" id="tab-1-1">
											<div class="col-sm-4">
												...
												<h4 class="job_category" style="word-wrap: break-word;">Law Enforcement</h4>
												<h5 class="job_sectors">Law Officer</h5>
												<ul class="job_list">
													<li><a href="#">Test Management Consultants Pvt Ltd </a></li>
													<li><a href="#">Connectpro Management Consultants Pvt Ltd </a></li>
												</ul> 
											</div><!--col-md-4-->
											<div class="col-sm-4">


												<h4 class="job_category" style="word-wrap: break-word;">Legal/Law</h4>
												<h5 class="job_sectors">Legal Adviser</h5>
												<ul class="job_list">
													<li><a href="#">Google infotech </a></li>
											...
											<div class="col-sm-4">
												...
												<h4 class="job_category" style="word-wrap: break-word;">Marketing/Sales</h4>
												<h5 class="job_sectors">Law Officer</h5>
												<ul class="job_list">
													<li><a href="#">Test Management Consultants Pvt Ltd </a></li>
													<li><a href="#">Connectpro Management Consultants Pvt Ltd </a></li>
											...
											<div class="col-sm-4">
												...
												<h4 class="job_category" style="word-wrap: break-word;">Media/Journalism</h4>
												<h5 class="job_sectors">Art Director</h5>
												<ul class="job_list">
													<li><a href="#">Sphere TravelMedia & Exhibition Private Limited </a></li>
													<li><a href="#">Sphere TravelMedia & Exhibition Private Limited </a></li>
												</ul> 
											</div><!--col-md-4-->
											<div class="col-sm-4">
												...
												<h4 class="job_category" style="word-wrap: break-word;">Production/Manufacturing/Maintenance</h4>
												<h5 class="job_sectors">Accounts Assistant</h5>
												<ul class="job_list">
													<li><a href="#">Marketing Services Pvt. Ltd </a></li>
													<li><a href="#">testing demo </a></li>
													<li><a href="#">CN Immigration Services Pvt. Ltd </a></li>
													<li><a href="#">Scriptsmall </a></li>
												</ul> 
											</div><!--col-md-4-->
											<div class="col-sm-4">


												<h4 class="job_category" style="word-wrap: break-word;">Tours and Travel</h4>
												<h5 class="job_sectors">Tour Operator</h5>
												<ul class="job_list">
													<li><a href="#">THE STAR HOLIDAYS </a></li>
													<li><a href="#">THE HOLIDAYS INN </a></li>
													<li><a href="#">THE HOLIDAYS INN </a></li>
												</ul> 
											</div><!--col-md-4-->
											<div class="col-sm-4">
												...
												<h4 class="job_category" style="word-wrap: break-word;">Transportation</h4>
												<h5 class="job_sectors">Train Operator</h5>
												<ul class="job_list">
													<li><a href="#">IP INTEGRATED SERVICES PVT LTS </a></li>
													<li><a href="#">IP INTEGRATED SERVICES PVT LTS </a></li>
												</ul> 
											</div><!--col-md-4-->
											<div class="col-sm-4">
												...
												<h4 class="job_category" style="word-wrap: break-word;">KPO/Technical Support</h4>
												<h5 class="job_sectors">Customer Relationship Officer</h5>
												<ul class="job_list">
													<li><a href="#">XYZ Hands HR Consultancy </a></li>
													<li><a href="#">Creative Hands HR Consultancy </a></li>
												</ul> 
											</div><!--col-md-4-->
											<div class="col-sm-4">


												<h4 class="job_category" style="word-wrap: break-word;">Strategy Management</h4>
												<h5 class="job_sectors">Stock Broking</h5>
												<ul class="job_list">
													<li><a href="#">Indian Institute of Management </a></li>
												</ul> 
											</div><!--col-md-4-->
											<div class="col-sm-4">
											</div><!--col-md-4-->
										...
										<div role="tabpanel" class="tab-pane" id="tab-1-2">
											<h4 class="job_category" style="word-wrap: break-word;">Information Technology</h4>
											<div class="col-sm-4">
											...
											<div class="col-sm-4">
												...
												<h5 class="job_sectors">Marketing Executives</h5>
												<ul class="job_list">
													<li><a href="#">Podar Education Network Pvt Ltd </a></li>
													<li><a href="#">Podar Education Network Pvt Ltd </a></li>
												</ul>
											...
											<div class="col-sm-4">
												...
												<h5 class="job_sectors">Asst. Sales Manager</h5>
												<ul class="job_list">
													<li><a href="#">testing demo </a></li>
													<li><a href="#">testing demo </a></li>
												</ul>
										...
										<div role="tabpanel" class="tab-pane" id="tab-1-3">
											<h4 class="job_category" style="word-wrap: break-word;">Manufacturing</h4>
											<div class="col-sm-4">
											...
											<div class="col-sm-4">
												...
												<h5 class="job_sectors">Maintenance Supervisor</h5>
												<ul class="job_list">
													<li><a href="#">ABC India Ltd  </a></li>
													<li><a href="#">Inet </a></li>
											...
											<div class="col-sm-4">
												...
												<h5 class="job_sectors">Instructional Designer</h5>
												<ul class="job_list">
										...
										<div role="tabpanel" class="tab-pane" id="tab-1-4">
											<h4 class="job_category" style="word-wrap: break-word;">Services</h4>
					...
					<div class="col-sm-3 right_box">

						<div class="col-sm-12 box_1 base_box">
							<h4 class="head">Best Consultants Zone</h4>
							<div class="row">

								<div class="col-sm-4 col-xs-4">
									<a href='jobsearch_all79bc.html?locat=Aduthurai%20alias%20maruthuvakudi' style='color:rgb(56, 112, 159)'>
										<img src="<?php echo base_url(); ?>asset/public/assets1/img/icons/ahmedabad.png">
										<p>Aduthurai alias maruthuvakudi</p>
									</a>
								</div>

								<div class="col-sm-4 col-xs-4">
									<a href='jobsearch_alld224.html?locat=Astara' style='color:rgb(56, 112, 159)'>
										<img src="<?php echo base_url(); ?>asset/public/assets1/img/icons/ahmedabad.png">
										<p>Astara</p>
									</a>
								</div>
								...
								<div class="col-sm-4 col-xs-4">
									<a href='jobsearch_all39b7.html?locat=Bableshwar' style='color:rgb(56, 112, 159)'>
										<img src="<?php echo base_url(); ?>asset/public/assets1/img/icons/ahmedabad.png">
										<p>Bableshwar</p>
									</a>
								</div>
								...
								<div class="col-sm-4 col-xs-4">
									<a href='jobsearch_allf63a.html?locat=Baisi' style='color:rgb(56, 112, 159)'>
										<img src="<?php echo base_url(); ?>asset/public/assets1/img/icons/ahmedabad.png">
										<p>Baisi</p>
									</a>
								</div>
								...
								<div class="col-sm-4 col-xs-4">
									<a href='jobsearch_allb6ee.html?locat=Barbil' style='color:rgb(56, 112, 159)'>
										<img src="<?php echo base_url(); ?>asset/public/assets1/img/icons/ahmedabad.png">
										<p>Barbil</p>
									</a>
								</div>
								...
								<div class="col-sm-4 col-xs-4">
									<a href='jobsearch_all2a1e.html?locat=Bastar' style='color:rgb(56, 112, 159)'>
										<img src="<?php echo base_url(); ?>asset/public/assets1/img/icons/ahmedabad.png">
										<p>Bastar</p>
									</a>
								</div>
								...
								<div class="col-sm-4 col-xs-4">
									<a href='jobsearch_allc3b1.html?locat=Bumthang' style='color:rgb(56, 112, 159)'>
										<img src="<?php echo base_url(); ?>asset/public/assets1/img/icons/ahmedabad.png">
										<p>Bumthang</p>
									</a>
								</div>
								...
								<div class="col-sm-4 col-xs-4">
									<a href='jobsearch_all595c.html?locat=Dhanbad' style='color:rgb(56, 112, 159)'>
										<img src="<?php echo base_url(); ?>asset/public/assets1/img/icons/ahmedabad.png">
										<p>Dhanbad</p>
									</a>
								</div>
								...
								<div class="col-sm-4 col-xs-4">
									<a href='jobsearch_all335e.html?locat=Elbasan' style='color:rgb(56, 112, 159)'>
										<img src="<?php echo base_url(); ?>asset/public/assets1/img/icons/ahmedabad.png">
										<p>Elbasan</p>
									</a>
								</div>
							</div>
							<a href="job_by_area.html" class="btn btn_default btn-block">View All</a>
						</div>
						

						<div class="col-sm-12 base_box ad_box">

							<a  href='#' target="_blank" style="width:100%;"><img src='../../../../phpscriptsmall.biz/demo/jobsite/images/tmp/banner_ad_336x280_blue1.jpg' /></a>							
						</div>
						
						<div class="col-sm-12 base_box job_aleart_box">
							<h4 class="head">Create Your Job Alert</h4>
							<p>Specify your criteria and Regularly receive jobs of your choice
							Be the first to apply for these jobs Stay updated about the job market.</p>
							<div class="form-groub"><input class="btn btn_default btn-block" data-toggle="modal" data-target="#createjob" value="Create Now" type="button"></div>
						</div>				
					</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-9">
						...
						<a  href='#' target="_blank" style="width:100%;"><img src='<?php echo base_url(); ?>asset/public/images/sponsored-ads.jpg' /></a> 					
					</div>
			...
			<div class="container-fluid">
				<div class="container">
					<div class="col-sm-9">
						<div class="row">
							<div class="main-heading">
								<h2 class="text-left">Browse <span>Jobs</span></h2>
							</div>
						</div>
						<div class="row home_browse_job">
							<div class="col-sm-4">
								<div class="col-sm-12 job_box">
									<a href='jobsearch8fb1.html?category=34'>
										<span class="it_job_icon" style="background-image: url(<?php echo base_url(); ?>asset/public/assets1/img/desk.png);"></span>
										Law Enforcement <br>
										<span> 1</span>
									</a>
								</div>
							...
							<div class="col-sm-4">
								<div class="col-sm-12 job_box">
									<a href='jobsearch4bfd.html?category=35'>
										<span class="it_job_icon" style="background-image: url(<?php echo base_url(); ?>asset/public/assets1/img/rising.png);"></span>
										Legal/Law <br>
										<span> 2</span>
									</a>
								</div>
							...
							<div class="col-sm-4">
								<div class="col-sm-12 job_box">
									<a href='jobsearch738e.html?category=36'>
										<span class="it_job_icon" style="background-image: url(<?php echo base_url(); ?>asset/public/assets1/img/handshake.png);"></span>
										Marketing/Sales <br>
										<span> 5</span>
									</a>
								</div>
							...
							<div class="col-sm-4">
								<div class="col-sm-12 job_box">
									<a href='jobsearchcca0.html?category=37'>
										<span class="it_job_icon" style="background-image: url(<?php echo base_url(); ?>asset/public/assets1/img/necklace.png);"></span>
										Media/Journalism <br>
										<span> 2</span>
									</a>
								</div>
							...
							<div class="col-sm-4">
								<div class="col-sm-12 job_box">
									<a href='jobsearch2f09.html?category=38'>
										<span class="it_job_icon" style="background-image: url(<?php echo base_url(); ?>asset/public/assets1/img/manufacture.png);"></span>
										Production/Manufa... <br>
										<span> 7</span>
									</a>
								</div>
							</div>
							<div class="col-sm-4">
								<div class="col-sm-12 job_box">
									<a href='jobsearch7999.html?category=40'>
										<span class="it_job_icon" style="background-image: url(<?php echo base_url(); ?>asset/public/assets1/img/step-2.png);"></span>
										Tours and Travel <br>
										<span> 3</span>
									</a>
								</div>
							...
							<div class="col-sm-4">
								<div class="col-sm-12 job_box">
									<a href='jobsearch3dc1.html?category=41'>
										<span class="it_job_icon" style="background-image: url(<?php echo base_url(); ?>asset/public/assets1/img/desk.png);"></span>
										Transportation <br>
										<span> 2</span>
									</a>
							...
							<div class="col-sm-4">
								<div class="col-sm-12 job_box">
									<a href='jobsearche9fc.html?category=42'>
										<span class="it_job_icon" style="background-image: url(<?php echo base_url(); ?>asset/public/assets1/img/telemarketer.png);"></span>
										KPO/Technical Sup... <br>
										<span> 2</span>
									</a>
								</div>
							</div>
							<div class="col-sm-4">
								<div class="col-sm-12 job_box">
									<a href='jobsearchafc4.html?category=44'>
										<span class="it_job_icon" style="background-image: url(<?php echo base_url(); ?>asset/public/assets1/img/step-3.png);"></span>
										Strategy Manageme... <br>
										<span> 1</span>
									</a>
								</div>
							</div>
							<div class="col-sm-4">
								<div class="col-sm-12 job_box">
									<a href='jobsearch6e8e.html?category=50'>
										<span class="it_job_icon" style="background-image: url(<?php echo base_url(); ?>asset/public/assets1/img/rising.png);"></span>
										IT-ERP-Oracle <br>
										<span> 7</span>
									</a>
							...
							<div class="col-sm-4">
								<div class="col-sm-12 job_box">
									<a href='jobsearch2be0.html?category=51'>
										<span class="it_job_icon" style="background-image: url(<?php echo base_url(); ?>asset/public/assets1/img/necklace.png);"></span>
										Media  <br>
										<span> 1</span>
									</a>
							...
							<div class="col-sm-4">
								<div class="col-sm-12 job_box">
									<a href='jobsearche01f.html?category=53'>
										<span class="it_job_icon" style="background-image: url(<?php echo base_url(); ?>asset/public/assets1/img/telemarketer.png);"></span>
										IT - BPO <br>
										<span> 3</span>
									</a>
							...
							<div class="col-sm-4">
								<div class="col-sm-12 job_box">
									<a href='jobsearch3da7.html?category=54'>
										<span class="it_job_icon" style="background-image: url(<?php echo base_url(); ?>asset/public/assets1/img/step-2.png);"></span>
										NGO/Social Servic... <br>
										<span> 6</span>
									</a>
								</div>
							</div>
							<div class="col-sm-4">
								<div class="col-sm-12 job_box">
									<a href='jobsearch28ec.html?category=55'>
										<span class="it_job_icon" style="background-image: url(<?php echo base_url(); ?>asset/public/assets1/img/manufacture.png);"></span>
										Management <br>
										<span> 2</span>
									</a>
					...
					<div class="col-sm-3 right_box">
						<div class="col-sm-12 base_box top_skill_box">
							<h4 class="head">Top Skill</h4>
							<ul class="top_skill">

								<li><a href='jobsearch6e8e.html?category=50' style="word-wrap: break-word;">IT-ERP-Oracle</a></li>				

								<li><a href='jobsearch3da7.html?category=54' style="word-wrap: break-word;">NGO/Social Services</a></li>				

								<li><a href='jobsearche01f.html?category=53' style="word-wrap: break-word;">IT - BPO</a></li>				

								<li><a href='jobsearche9fc.html?category=42' style="word-wrap: break-word;">KPO/Technical Support</a></li>				

								<li><a href='jobsearch738e.html?category=36' style="word-wrap: break-word;">Marketing/Sales</a></li>				

								<li><a href='jobsearch4bfd.html?category=35' style="word-wrap: break-word;">Legal/Law</a></li>				

								<li><a href='jobsearch2f09.html?category=38' style="word-wrap: break-word;">Production/Manufacturing/Maintenance</a></li>				

								<li><a href='jobsearchcca0.html?category=37' style="word-wrap: break-word;">Media/Journalism</a></li>				

								<li><a href='jobsearchafc4.html?category=44' style="word-wrap: break-word;">Strategy Management</a></li>				

								<li><a href='jobsearch7999.html?category=40' style="word-wrap: break-word;">Tours And Travel</a></li>				

								<li><a href='jobsearch3dc1.html?category=41' style="word-wrap: break-word;">Transportation</a></li>				

								<li><a href='jobsearch28ec.html?category=55' style="word-wrap: break-word;">Management</a></li>				

								<li><a href='jobsearch8fb1.html?category=34' style="word-wrap: break-word;">Law Enforcement</a></li>				

								<li><a href='jobsearch2be0.html?category=51' style="word-wrap: break-word;">Media </a></li>				

								<li><a href="job_by_category.html">View All Jobs</a></li>
							</ul>								
						</div>
					</div>
				</div>
		...
		<div class="clearfix"></div>
		<!-- video section Start -->
		<section class="video-sec dark" id="video" style="background-image:url(<?php echo base_url(); ?>asset/public/assets1/img/banner-10.jpg);">
			<div class="container">
				<div class="row">
					<div class="item wow fadeInUpBig animated animated col-sm-3 stat" >
		...
		<section>
			<div class="container">
				<div class="row">
					<div class="col-sm-9 recent_job">
						<div class="main-heading col-sm-12 mb0i">
							<h2 class="text-left">Recent <span>Jobs</span></h2>
						</div>
						...
						<div class="col-sm-3 right_box">
							<div class="col-sm-12 base_box top_skill_box">
								<h4 class="head">Premium Designations</h4>
								<ul class="top_skill">
									<li><a href="job-detail-pagedf91.html?jid=31491543252"></a></li>
									<li><a href="job-detail-pageb15d.html?jid=31513082001">GM</a></li>
									<li><a href="job-detail-pagedc90.html?jid=31526737132">Consultant</a></li>
									<li><a href="job-detail-pagefb37.html?jid=31527832748">Associate Vice President - Talent Acquisition - IT/BPO/KPO</a></li>
									<li><a href="job-detail-page6fbd.html?jid=31527833049">IT- Application- Oracle ERP.</a></li>
									<li><a href="job-detail-pagefe63.html?jid=31527833317">BPO / KPO / CCE / Process Associate / Technical Support / CSA</a></li>
									<li><a href="job-detail-page1062.html?jid=31527833570">Manager, India Counterfeit and Supply Chain Security</a></li>
									<li><a href="job-detail-page65bb.html?jid=31527833800">Legal Associate - Bombay High Court Litigation ( For Law Firm )</a></li>
									<li><a href="job-detail-page787a.html?jid=31527834595">Abroad Opportunities | Manager - Sales & Marketing</a></li>
									<li><a href="job-detail-page49e9.html?jid=31527834957">Manager Media Sales (print & Digital) - Grehlakshmi & Cricket Today</a></li>
									<li><a href="jobsearch_all.html">View All Jobs</a></li>
								</ul>								
							</div>

							<div class="col-sm-12 base_box ad_box">

								<a  href='#' target="_blank" style="width:100%;"><img src='../../../../phpscriptsmall.biz/demo/jobsite/images/tmp/banner_ad_336x280_white.jpg' /></a>											
							</div>
				...
				<div class="modal-dialog modal-lg" role="document">
					<div class="modal-content">
						<div class="modal-header avd-serbg">
							<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"> <img src="<?php echo base_url(); ?>asset/public/images/close-icon.png"></span></button>
